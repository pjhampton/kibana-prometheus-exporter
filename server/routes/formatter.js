...
export default function (info) {
    ...
    metrics['kibana_os_cpu_load_average{interval="1m"}'] = info.metrics.os.load['1m'] || 0;
    metrics['kibana_os_cpu_load_average{interval="5m"}'] = info.metrics.os.load['5m'] || 0;
    metrics['kibana_os_cpu_load_average{interval="15m"}'] = info.metrics.os.load['15m'] || 0;
